...
btn.addEventListener('click',() => {
  ...
  for(i=0;i<fmdata.length;i++){
    ...
    if(al==0){
      if(k%2==0){
        html += '<tr><td>'+'<a href="'+ fmdata[i][1] + '" target="_blank"><img src="'+ fmdata[i][0] + '" width="300px" height="200px"></a>'+'</td>';
      }else{
        html += '<td>'+'<a href="'+ fmdata[i][1] + '" target="_blank"><img src="'+ fmdata[i][0] + '" width="300px" height="200px"></a>'+'</td></tr>';
      }
      k+=1;
    }
  }
